    ...
    >
      <div class="xs:p-0 mx-auto p-10 md:w-full md:max-w-md">
        <div class="w-full rounded-lg bg-white shadow">
          <div class="px-5 py-7">
            <label class="block pb-1 text-sm text-gray-600">First Name</label>
            <input
              type="text"
              class="mb-5 mt-1 w-full rounded-lg border px-3 py-2 text-sm outline-blue-600"
            />
            <label class="block pb-1 text-sm text-gray-600">Last Name</label>
            <input
              type="text"
              class="mb-5 mt-1 w-full rounded-lg border px-3 py-2 text-sm outline-blue-600"
            />
            ...
            <input
              ...
              class="mb-5 mt-1 w-full rounded-lg border px-3 py-2 text-sm outline-blue-600"
            />
            <label class="block pb-1 text-sm text-gray-600"
            ...
            >
              <span class="mr-2 inline-block">Register</span>
            </button>
          </div>
        </div>
        <div class="py-5">
