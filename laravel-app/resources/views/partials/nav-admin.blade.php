<nav class="flex items-center justify-end bg-primary-grey-100 px-4 py-4 font-light shadow-md">
  <ul class="flex w-full items-center justify-end gap-8 px-14">
    <li class="relative mr-auto flex items-center text-lg">
      <a href="{{ route("admin") }}" class="custom-underline-transition custom-number-bubble-after">
        My Panel
      </a>
    </li>
    <li class="">
      <a class="transform rounded-[8px] bg-blue-600 px-4 py-2 capitalize text-slate-100 duration-200 ease-in-out hover:bg-blue-700"
        href="{{ route("admin_create") }}">
        Add new
      </a>
    </li>
    <li class="relative flex items-center">
      <button id="user-btn" class="custom-underline-transition custom-number-bubble-after">
      ...
      <div id="user-nav"
        ...
        <ul class="flex flex-col">
          <li class="rounded-t-[8px]">
            <a id="login-link" href="{{ route("index") }}}"
              class="block px-4 py-2 hover:bg-gray-100 hover:text-red-600 hover:underline">Log out</a>
          </li>
        </ul>
      </div>
    </li>
