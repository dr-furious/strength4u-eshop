...
<html lang="en">
  ...
  <body class="font-dm">
    ...
    <main>
      <section
        class="flex min-h-screen flex-col items-center gap-2 p-10 text-center"
      >
        <img
        ...
        <h2>Your order number is <span class="font-bold">245321</span>.</h2>
        <h2>
          We've sent a confirmation email to
          <span class="font-bold">john.doe@gmail.com</span>.
        </h2>
      </section>
    </main>
